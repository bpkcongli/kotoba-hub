...
- [x] `SYL-02` Tetapkan coverage scope seed awal: detail konten N5 sampai N4, dengan skeleton extensible untuk N3 sampai N2. Lihat [syllabus/README.md](./syllabus/README.md), [syllabus/source-of-truth-and-ingestion-plan.md](./syllabus/source-of-truth-and-ingestion-plan.md), dan [syllabus/seed-coverage-scope.md](./syllabus/seed-coverage-scope.md).
- [x] `SYL-03` Definisikan schema seed content agar mudah diimport ke database atau dibaca langsung dari repo. Fokus task ini adalah bentuk schema, bukan crawling penuh dataset. Lihat [syllabus/seed-content-schema.md](./syllabus/seed-content-schema.md), [syllabus/source-of-truth-and-ingestion-plan.md](./syllabus/source-of-truth-and-ingestion-plan.md), [syllabus/schema/seed-manifest.schema.json](./syllabus/schema/seed-manifest.schema.json), dan [syllabus/schema/track-seed.schema.json](./syllabus/schema/track-seed.schema.json).
- [x] `SYL-03A` Mulai akuisisi raw source untuk seed syllabus: download source resmi yang berbentuk dataset, lalu lakukan crawling teratribusi untuk source yang memang tidak punya bulk export resmi, terutama grammar Bunpro dari deck level dan halaman grammar point detail. Simpan snapshot mentah dan catatan provenance di bawah folder source syllabus agar transform seed bisa diaudit. Snapshot baseline lihat [syllabus/raw-source-acquisition.md](./syllabus/raw-source-acquisition.md).
- [x] `SYL-04` Susun daftar unit per level JLPT dan urutan belajar yang masuk akal untuk learner journey KotobaHub. Lihat [syllabus/README.md](./syllabus/README.md), [syllabus/jlpt-syllabus-structure.md](./syllabus/jlpt-syllabus-structure.md), [syllabus/seed-coverage-scope.md](./syllabus/seed-coverage-scope.md), dan [syllabus/jlpt-unit-sequencing.md](./syllabus/jlpt-unit-sequencing.md).
- [x] `SYL-05` Turunkan setiap unit menjadi lesson dan daftar skill yang bisa di-track oleh sistem. Lihat [syllabus/jlpt-lesson-and-skill-breakdown.md](./syllabus/jlpt-lesson-and-skill-breakdown.md).
- [x] `SYL-06` Tandai skill yang dipakai oleh flashcard, skill yang dipakai oleh random questions, dan skill yang dipakai keduanya. Lihat [syllabus/skill-activity-support-matrix.md](./syllabus/skill-activity-support-matrix.md).
- [x] `SYL-06A` Definisikan mapping dari skill syllabus ke system flashcard deck bawaan, terutama untuk `KANJI` dan `VOCABULARY`, termasuk aturan grouping deck per level/unit, membership item, dan hubungan `skill -> flashcard item -> flashcard deck`. Lihat [syllabus/flashcard-deck-mapping.md](./syllabus/flashcard-deck-mapping.md).
- [x] `SYL-06B` Generate seed JSON final untuk `content/syllabus/manifest.json` dan `content/syllabus/tracks/*.json` berdasarkan schema resmi, hasil breakdown unit/lesson/skill, support flags, serta mapping deck yang sudah dikunci. Validasi payload terhadap [syllabus/schema/seed-manifest.schema.json](./syllabus/schema/seed-manifest.schema.json) dan [syllabus/schema/track-seed.schema.json](./syllabus/schema/track-seed.schema.json), lalu pastikan provenance source masih bisa diaudit dari [content/syllabus/sources/](/home/user/Testing/kotoba-hub/content/syllabus/sources/README.md:1).
